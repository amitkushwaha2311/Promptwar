        ...
        <div className="lg:col-span-3 rounded-2xl relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 border border-slate-800/50 p-8 min-h-[280px] flex flex-col justify-between">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-white mb-2 leading-tight">
              One Step Closer<br />to Your <span className="text-cyan-400">Dream Project.</span>
            </h1>
              ...
              <div className="flex items-start justify-between">
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    <h2 className="text-xl font-bold text-white tracking-tight">AI Resume Analyzer & ATS Optimizer</h2>
                  ...
                  <p className="text-sm text-slate-400 mb-4">Deep parsing of resumes with semantic analysis and AI-powered suggestions.</p>
                </div>
              </div>
